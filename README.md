...
<h2 align="center" font-size: 10px>Projeto de conversor de moedas, Real, Dolar, Euro, Bitcoin e Libra. sendo possivel a conversão de ambas entre se.
O projeto consome um API atualizando os valores de cada moeda com a cotação do dia.
